...
class Paypal
{
    ...
    public function __construct($client_id = '', $secret_key = '', $paypal_mode = '')
    {
        ...
        $this->secret_key   = $Settings['paypal_client_secrete'];
        $this->URL_V2       = $Settings['paypal_payment_type'] == 'live' ? 'https://api-m.paypal.com/v2/' : 'https://api-m.sandbox.paypal.com/v2/';
        $this->URL_V1       = $Settings['paypal_payment_type'] == 'live' ? 'https://api-m.paypal.com/v1/' : 'https://api-m.sandbox.paypal.com/v1/';
